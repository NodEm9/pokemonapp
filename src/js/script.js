...
let pokemonRepository = (function () {
  ...
  //Function to get all pokemon and sort the result
  // and the return the sorted list of pokemon
  function getAll() {
   let sorttedPokemon = pokemonList.sort(function (a, b) { 
      return a.name.localeCompare(b.name);
    });
    return sorttedPokemon;
  }
